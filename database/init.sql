...
CREATE TABLE users (
    ...
    trade_rating DECIMAL(2,1) DEFAULT 5.0 COMMENT '交易评分',
...
CREATE TABLE logs (
    ...
    weather TINYINT DEFAULT 1 COMMENT '天气',
    ...
    water_level TINYINT DEFAULT 2 COMMENT '水位',
    lures_used JSON DEFAULT NULL COMMENT '使用拟饵',
    rod VARCHAR(100) DEFAULT NULL COMMENT '竿子',
    reel VARCHAR(100) DEFAULT NULL COMMENT '轮子',
    line VARCHAR(100) DEFAULT NULL COMMENT '线组',
    catch_count INT DEFAULT 0 COMMENT '渔获数量',
    max_length DECIMAL(5,1) DEFAULT NULL COMMENT '最长大鱼',
    max_weight DECIMAL(5,2) DEFAULT NULL COMMENT '最重大鱼',
    notes TEXT DEFAULT NULL COMMENT '心得',
...
CREATE TABLE log_catches (
    ...
    length DECIMAL(5,1) DEFAULT NULL COMMENT '长度',
    weight DECIMAL(6,1) DEFAULT NULL COMMENT '重量',
...
CREATE TABLE items (
    ...
    condition TINYINT NOT NULL COMMENT '成色',
    price DECIMAL(10,2) NOT NULL COMMENT '售价',
    original_price DECIMAL(10,2) DEFAULT NULL COMMENT '原价',
    photos JSON NOT NULL COMMENT '照片',
    video_url VARCHAR(255) DEFAULT NULL COMMENT '视频',
    province VARCHAR(50) NOT NULL COMMENT '省',
    city VARCHAR(50) NOT NULL COMMENT '市',
    shipping TINYINT DEFAULT 1 COMMENT '物流',
...
CREATE TABLE videos (
    ...
    spot_id BIGINT UNSIGNED DEFAULT NULL COMMENT '关联钓点',
...
CREATE TABLE articles (
    ...
    cover_url VARCHAR(255) DEFAULT NULL COMMENT '封面',
    source_name VARCHAR(100) NOT NULL COMMENT '来源',
    source_url VARCHAR(500) DEFAULT NULL COMMENT '原文链接',
    author VARCHAR(100) DEFAULT NULL COMMENT '作者',
    category TINYINT DEFAULT 1 COMMENT '分类',
    tags JSON DEFAULT NULL COMMENT '标签',
    view_count INT DEFAULT 0 COMMENT '阅读数',
    favorite_count INT DEFAULT 0 COMMENT '收藏数',
    crawl_source VARCHAR(50) DEFAULT NULL COMMENT '抓取来源',
...
CREATE TABLE favorites (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    user_id BIGINT UNSIGNED NOT NULL COMMENT '用户 ID',
    target_type TINYINT NOT NULL COMMENT '类型',
...
-- INSERT INTO admins (user_id, username, password_hash, role) VALUES (1, 'admin', '$2a$10$...', 1);
